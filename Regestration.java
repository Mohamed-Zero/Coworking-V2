...
import static com.mycompany.coworkingspace.CoworkingSpace.Fvisitors;
import static com.mycompany.coworkingspace.CoworkingSpace.Gvisitors;
import static com.mycompany.coworkingspace.CoworkingSpace.Ivisitors;
 ...
 private static Scanner input=new Scanner(System.in);
    ...
    public String setEmail(String Email) {
       check=true;
           ...
           if(check&&Email.indexOf("@")!=-1&&!Email.startsWith("@"))
        this.Email = Email;
           else{
     ...
     public static AbstractVisitor VisitorRegester(){
        ...
        email= r.setEmail(email);
          ...
          switch(choice){
              case 1:
                  type="General";
                   Gvisitors.add(new GeneralVisitor (name,email,phone,pass,type));
                  break;
               case 2:
                  type="Formal";
                   Fvisitors.add(new FormalVisitor (name,email,phone,pass,type));
                   break;
                case 3:
                  type="Instructor";
                    Ivisitors.add(new InstructorVisitor (name,email,phone,pass,type));
                    break;
          }
